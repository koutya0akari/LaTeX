...
\definecolor{frameinnercolor}{rgb}{0.21, 0.27, 0.31}
...
{\begin{theorem}[#1]{Theorem}%
}{\end{theorem}}

\newenvironment{proposition}[1][]%
{\begin{theorem}[#1]{Proposition}%
}{\end{theorem}}

\newenvironment{lemma}[1][]%
{\begin{theorem}[#1]{Lemma}%
}{\end{theorem}}

\newenvironment{corollary}[1][]%
{\begin{theorem}[#1]{Corollary}%
}{\end{theorem}}

\newenvironment{dfn}[1][]%
{\begin{theorem}[#1]{Definition}%
}{\end{theorem}}

\newenvironment{prob}[1][]%
{\begin{theorem}[#1]{Probrem}%
}{\end{theorem}}

\newenvironment{example}[1][]%
{\begin{theorem}[#1]{Example}%
}{\end{theorem}}

\newtheorem*{answer*}{$\mathcal{A}$}
