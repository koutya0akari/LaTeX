...
boxed title style={colback=black,left=0pt,right=0pt}, 
...
underlay unbroken={
  ...
  --([yshift=4pt]frame.north east)
  -- ([yshift=-4pt]frame.south east) 
  -- ([yshift=-4pt]frame.south west) 
  -- ([yshift=4pt]frame.north west);
  },
underlay first={
  %in
...
top=0pt,bottom=2pt,left=4pt,right=0pt,
...
{enhanced, colback=white, colframe=white,
 fonttitle=\bfseries,coltitle=black, fonttitle=\gtfamily, 
enlarge top by=2mm, enlarge bottom by=2mm, breakable, 
boxed title style={left=0mm,right=0mm,top=1mm,bottom=1mm},
underlay unbroken={
